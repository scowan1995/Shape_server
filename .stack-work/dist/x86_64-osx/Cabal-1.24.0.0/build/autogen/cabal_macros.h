...
/* package funcProj-0.1.0.0 */
#define VERSION_funcProj "0.1.0.0"
#define MIN_VERSION_funcProj(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "funcProj-0.1.0.0-7s6aX0jPQkMFnqGLbVy140"

#define CURRENT_PACKAGE_KEY "funcProj-0.1.0.0-7s6aX0jPQkMFnqGLbVy140"
